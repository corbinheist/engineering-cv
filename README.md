...
- SAPIENT (BSI Flex 335 / NATO STANAG), ASTERIX (Cat 048/062), Cursor on Target (CoT/TAK), Link 16, FAAD C2

### Software & APIs

- Python (Pandas, NumPy, Bokeh), Jupyter Notebooks, data visualization (Seaborn, Matplotlib, Plotly)
- REST APIs (Flask-RESTX, OpenAPI/Swagger), JSON-RPC, protocol development
- Docker, Git, Linux (Ubuntu, RedHat), Jira, Confluence
